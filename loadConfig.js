  ...
  return {
    ...
    plans: {
      ...
      quarterly: {
        ...
        label: process.env.PLAN_QUARTERLY_LABEL || '3 meses (50% off )',
        priceLabel: process.env.PLAN_QUARTERLY_PRICE_LABEL || 'R$ 29,85',
        price: parseFloat(process.env.PLAN_QUARTERLY_PRICE) || 29.85,
      ...
      semestrial: {
        ...
        priceLabel: process.env.PLAN_SEMESTRIAL_PRICE_LABEL || 'R$ 59,70',
        price: parseFloat(process.env.PLAN_SEMESTRIAL_PRICE) || 59.70,
        description: process.env.PLAN_SEMESTRIAL_DESCRIPTION || 'Assinatura semestral'
      }
    },
    
    redirectUrl: process.env.REDIRECT_URL || 'https://stellabeghini.com/assinatura-premiada/'
  };
}
